...
from core.env_validation import ENV_NAME_RE
...
def _local_user_env_value_strict(name: str) -> str | None:
    """Read a Windows-user variable without confusing failure with absence."""
    if os.name != "nt":
        return None
    import winreg
